...
import logo from "../../assets/Logo/codemy.png";
import logo2 from "../../assets/Logo/new/logo png.png";
  ...
  return (
    <div className="h-16 flex nav-bar yaha items-center justify-center border-b-[1px] border-b-richblack-700 border-opacity-40 shadow-richblack-700 shadow-lg">
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        <Link to={"/"} >
          <img src={logo} alt="" className="logo hidden md:block object-contain w-[150px] "  loading="lazy" />
              ...
              return (
                ...
                >
                  {link.title === "Catalog" ? (
                    ...
                    <NavLink
                      className={
                        "text-richblack-200 text-sm md:text-md hover:text-richblack-5"
                      }
                      to={link?.path}
                    >
                      {link.title}
        ...
        <div className="flex gap-4 items-center">
          {user &&
            ...
            (cart.length ? (
              ...
              >
                ...
                <span
                  className={`-top-3  text-center -right-3 absolute bg-yellow-25 w-5 h-5 text-[15px] flex items-center justify-center rounded-full text-black shadow-lg shadow-yellow-50 ${
                    hovering ? "" : "circle"
                  }  `}
                >
                  {cart.length}
              ...
              <Link to={"/dashboard/cart"} className="text-white md:text-xl">
                <BsCart3 />
              </Link>
            ))}
          ...
          {token === null && (
            <Link to={"/login"}>
              <button className="bg-richblack-900 border-richblack-400 border-t border-l text-richblack-5 px-3 py-2 rounded-lg">
                <span className="hidden md:block">Log In</span> <span className="md:hidden">SignIn</span>
              </button>
            </Link>
          )}
